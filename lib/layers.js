        ...
        _.each(inputLayer["styles"], function(inputStyle) {
            ...
            if (_.isArray(inputStyle["Rule"]))
                _.each(inputStyle["Rule"], function(inputRule) {
                    var layer = buildLayer(inputLayer, inputStyle, inputRule);
                    if (layer)
                        mapboxLayers.push(layer);
                });
            else if (inputStyle["Rule"]) {
                var layer = buildLayer(inputLayer, inputStyle, inputStyle["Rule"]);
                if (layer)
                    mapboxLayers.push(layer);
            }
 ...
 */
function buildLayer(inputLayer, inputStyle, inputRule) {
